  ...
  return (
    <div className="relative h-[820px] w-full overflow-hidden md:h-[720px] lg:h-[720px]">
      <img
        src={video}
        alt="img"
        className="absolute top-0 left-0 w-full h-[880px] object-cover brightness-50"
      />
      <div className="relative flex-col justify-center w-full text-white z-10  max-w-[1220px] mx-auto grid md:grid-cols-2">
        <div className=" px-5">
          ...
          <p className=" font-normal text-lg md:text-xl py-5 text-white">
            Lorem ipsum dolor sit dvhvw fsf wdu amet consecur adipisicing elit.
            Mollitia doloribus voluptatem illum adipisci eveniet.
          </p>
          <div className="flex items-center gap-3">
            <NavLink
              to="/discover"
              className="mt-8 px-5 py-2 font-bold bg-green-500 rounded-full text-white hover:bg-green-400 duration-500"
            >
              Discover
            </NavLink>
            <NavLink
              to="/login"
              className="md:hidden mt-8 px-5 py-2 font-bold bg-green-500 rounded-full text-white hover:bg-green-400 duration-500"
            >
              Login
            </NavLink>
          </div>
        ...
        <div className="images mt-2 md:mt-20 px-5">
          <img
            className={`transition-transform duration-500 mb-32 size-fit image-responsive`}
            src={img}
            alt=""
          />
        </div>
