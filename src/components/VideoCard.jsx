...
import videoSrc from "../videos/hh34.jpg";
        ...
        <div className="relative p-3">
          ...
          <div class="absolute inset-0 flex flex-col md:flex-row md:justify-between justify-around items-center text-white bg-opacity-50 p-4">
            <div className="w-full md:w-[60%] flex flex-col gap-2 p-5">
              ...
              <button className="md:w-[30%] text-base md:text-base lg:text-lg bg-blue-500 hover:bg-blue-600 duration-500 rounded-2xl py-2 px-3 md:px-5 md:py-3">
                Get Started
              </button>
            </div>
